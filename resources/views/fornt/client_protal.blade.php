  ...
  <div class="start" id="start">
    ...
    <div class="modal fade" id="myModal">
      <div class="modal-dialog modal-xl border">
        ...
        <!-- Modal body -->
        <div class="modal-body" style="background-color:: rgba(128,0,0,0.7);">
          <div class="form p-1">
            <form action="">
              <div class="row ml-2">
              ...
              <div class="row p-2">
                <div class="col-md-3 col-lg-3 col-xl-3 mb-1"> <input type="text" name="" disabled value="{{$found->Height}} Feet" id="" class="form-control" > </div>
                <div class="col-md-3 col-lg-3 col-xl-3 mb-1"> <input type="text" name="" disabled value="{{$found->Weight}} KG" id="" class="form-control" > </div>
                <div class="col-md-6 col-lg-5 col-xl-6 mb-1"> <input type="text" name="" disabled value="{{$found->Age}} yrs" id="" class="form-control" ></div>
              </div>
              <div class="row p-2">
                  ...
                  <form action="{{url('\Clientdata', $found->Pid)}}" method="post">
                      @csrf
                          ...
                          <div class="row mb-3 text-center">
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <label for="" class="text-dark text-center">Diabetes</label>
                                <input type="text" name="diabetes" id="text" class="form-control text-center" required>
                            </div>
    ...
    <div id="auto" class="Tables">
        ...
        <div class="" id="font">
        <br>
            <h4 class="text-center text-dark mb-3">Blood Pressure</h4>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              @elseif($dele->Status=="3")
                                <h6>Hyperthesis Stage1</h3>
                              @elseif($dele->Status=="4")
                                <h6>Hyperthesis Stage2</h3>
                              @elseif($dele->Status=="0")
                                <h6>n/a</h3>
                              @else
                                <h6>Ciritical</h3>
                              @endif
    ...
    <div class="diabetes mt-5 p-5">
      <h4 class="text-center text-dark mb-3">Diabetes</h4>
      <div id="auto" class="Tables tableFixHead">
