...
<div class='wrap'>
  ...
  <div class='c'></div>
    ...
    <a href="/index" class="text-left"><i class="fa fa-home text-white "> </i></a><h1 style="text-align: center; margin-bottom: 10px; color: white; font-family: geneva; font-size: 50px;">Welcome</h1>
        <div class="text-center mb-4">
            ...
            <h6 class="text-white">MEDICALCHAIN</h5>
        </div>
            ...
            @csrf
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <select name="user" id="B" required class="form-control">
                          <option class="bg-dark" value=""> -- SELECT WHO ARE YOU --</option>
                          <option class="bg-dark" value="cardio">Cardio Patient</option>
                          <option class="bg-dark" value="diabetes"> Diabetes Patient</option>
                        </select>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <input id="B" type="text" name="username" id="" id="" placeholder="Username" required class="form-control">
                    </div>
                </div>
                <div class="row mb-2">
                        <div class="col-12">
                            <!-- <label for="">Password</label> -->
                            <input id="B"type="password" name="password" id="" placeholder="Password" required class="form-control">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-12">
